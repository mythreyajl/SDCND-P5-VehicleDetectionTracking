...
[image4]: ./writeup_images/bounding_boxes.jpg
[image5]: ./writeup_images/heat_map.png
[image6]: ./writeup_images/median.jpg
[image7]: ./writeup_images/bounding_box_image.jpg
...
After extraction of HOG features for positive and negative samples and training a LinearSVC classifier to obtain a decision boundary, I do the following steps to run the vehicle detection and tracking system:

* Performing sliding window based feature matching on two scales to obtain individual bounding boxes with cars as shown below:
...
* After median filtering, the vehicle detection bounding boxes are obtained as shown below:

![alt text][image7]

This process is repeated frame after frame.
